...
LANG_STRINGS["ru_install_bot_reinstall_denied_ufw"]="Отказано в переустановке страницы подписок"
...
LANG_STRINGS["ru_install_bot_reinstall_denied_solobot"]="Отказано в переустановке страницы подписок"

...
LANG_STRINGS["en_install_bot_vsftpd"]="Would you like to install FTP?"
...
LANG_STRINGS["en_install_bot_ufw"]="Would you like to install Ufw?"
...
LANG_STRINGS["ru_install_bot_vsftpd"]="Желаете установить FTP?"
...
LANG_STRINGS["ru_install_bot_ufw"]="Желаете установить Ufw?"
